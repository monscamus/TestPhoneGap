...
function onSuccessInspections(response) {
    ...
    $j("#div_inspection_list").html("")
    var ul = $j('<ul data-role="listview" data-inset="true" data-theme="a" data-divider-theme="c" data-dividertheme="a"></ul>');
    ...
    $j.each(response.records, function(i, inspection) {
           ...
           var newLi = $j("<li><a href='application.html'>" + (i+1) + " - " + inspection.Inspection_Type__c + "</a></li>");
           ul.append(newLi);
           });
